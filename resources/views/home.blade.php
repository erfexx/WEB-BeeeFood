    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="{{asset('../assets/image/image_slider.jpg')}}" alt="Los Angeles" style="width:100%;">
            </div>

            <div class="item">
                <img src="{{asset('../assets/image/image_slider1.jpg')}}" alt="Chicago" style="width:100%;">
            </div>

            <div class="item">
                <img src="{{asset('../assets/image/image_slider2.jpg')}}" alt="New York" style="width:100%;">
            </div>

            <div class="item">
                <img src="{{asset('../assets/image/image_slider3.jpg')}}" alt="New York" style="width:100%;">
            </div>
    ...
    <div class="main-content">
        ...
        <div class="food-type-wrapper col-md-12">
            <div class="food-type-content col-md-2">
                <a href="">
                    <div class="food-type-image-wrapper">
                        <img class="food-type-image" src="{{asset('/assets/icon/breakfast.png')}}" width="70" alt="">
                    </div>
            ...
            <div class="food-type-content col-md-2">
                <a href="">
                    <div class="food-type-image-wrapper">
                        <img class="food-type-image" src="{{asset('/assets/icon/lunch.png')}}" width="70" alt="">
                    </div>
            ...
            <div class="food-type-content col-md-2">
                <a href="">
                    <div class="food-type-image-wrapper">
                        <img class="food-type-image" src="{{asset('/assets/icon/dinner.png')}}" width="70" alt="">
                    </div>
            ...
            <div class="food-type-content col-md-2">
                <a href="">
                    <div class="food-type-image-wrapper">
                        <img class="food-type-image" src="{{asset('/assets/icon/delivery.png')}}" width="70" alt="">
                    </div>
            ...
            <div class="food-type-content col-md-2">
                <a href="">
                    <div class="food-type-image-wrapper">
                        <img class="food-type-image" src="{{asset('/assets/icon/cafes.png')}}" width="70" alt="">
                    </div>
            ...
            <div class="food-type-content col-md-2">
                <a href="">
                    <div class="food-type-image-wrapper">
                        <img class="food-type-image" src="{{asset('/assets/icon/dessert.png')}}" width="70" alt="">
                    </div>
            ...
            <div class="food-wrapper col-md-9">
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/waroeng_western.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        ...
                        <div class="restaurant rating-image">
                            <img src="{{asset('../assets/image/4_5_star.png')}}" width="180" alt="">
                        </div>
                    </div>
                    <div class="restaurant-medal">
                        <img src="{{asset('../assets/image/medal.png')}}" width="50" alt="">
                    </div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/warung_steak_76.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/ayam_gepuk.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
        ...
        <div class="food-filter-wrapper">
            <div class="food-wrapper col-md-9">
                <div class="restaurant-wrapper" id="anggrek">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/ayam_geprek.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/berseri.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/ciz_n_chic.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/distrik69.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/fish_bite.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/milano_express.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/robak.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/saung_sambal.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/mie_aceh.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
                ...
                <div class="restaurant-wrapper">
                    <div class="restaurant-image">
                        <img src="{{asset('../assets/image/whatsup.jpg')}}" width="200" height="150" alt="">
                    </div>
                    <div class="restauran-info-wrapper">
                        <div class="restaurant-type-text">Breakfast, Lunch, Dinner, Delivery</div>
